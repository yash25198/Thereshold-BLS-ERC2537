            ...
            function sha2(data_, n_) -> _h {
                if iszero(
                    and(
                        ...
                        staticcall(gas(), 2, data_, n_, 0x00, 0x20)
                    )
                ) {
            ...
            function modfield(s_, b_) {
                ...
                if iszero(
                    and(
                        ...
                        staticcall(gas(), 5, s_, 0x100, b_, 0x40)
                    )
                ) {
                    revert(calldatasize(), 0x00)
                }
